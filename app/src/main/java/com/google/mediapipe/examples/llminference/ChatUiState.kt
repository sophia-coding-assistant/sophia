...
class ChatUiState(
    ...
    override fun createLoadingMessage(): String {
        ...
        Log.d("ChatUiState", "Created loading message: ${chatMessage.id}")
    ...
    override fun appendMessage(id: String, text: String, done: Boolean) {
        ...
        if (index != -1) {
            ...
            Log.d("ChatUiState", "Appended message: $text, Done: $done")
        }
    }
    ...
    override fun addMessage(text: String, author: String): String {
        ...
        _messages.add(chatMessage)
        Log.d("ChatUiState", "Added message: $text by $author")
        return chatMessage.id
    }
}
